!macro customInstall
  ...
  WriteRegStr HKCU "Software\Classes\*\shell\Diffly" "Icon" "$INSTDIR\resources\icon.ico"
  ...
  WriteRegStr HKCU "Software\Classes\Directory\shell\Diffly" "Icon" "$INSTDIR\resources\icon.ico"
  ...
  WriteRegStr HKCU "Software\Classes\Directory\Background\shell\Diffly" "Icon" "$INSTDIR\resources\icon.ico"
